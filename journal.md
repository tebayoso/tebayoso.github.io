...
<section class="section journal-header" style="padding-top: 120px;">
    <div class="section-container">
        <div class="section-header">
            <span class="section-tag">&lt;Journal /&gt;</span>
            <h2 class="section-title">
                Career <span class="text-gradient-cyan">Chronicle</span>
            </h2>
...
<section class="section journal-timeline">
    <div class="section-container">
        
        <!-- Quote Section -->
        <div class="journal-quote scroll-reveal">
            <blockquote>
                <p>"Si me das 6 horas y un hacha para cortar un árbol, voy a pasar 5 horas afilando el hacha y una dando hachazos." </p>
                <cite>— Mi filosofía de trabajo</cite>
            </blockquote>
        </div>
        ...
        <div class="journal-year scroll-reveal">
            ...
            <div class="journal-items">
                <div class="journal-item">
                    ...
                    <div class="journal-content">
                        <div class="journal-header-row">
                            <h3 class="journal-title">First Professional Role</h3>
        ...
        <div class="journal-year scroll-reveal">
            ...
            <div class="journal-items">
                <div class="journal-item">
                    ...
                    <div class="journal-content">
                        <div class="journal-header-row">
                            <h3 class="journal-title">The Pivot</h3>
                            <span class="journal-type milestone">Milestone</span>
                        </div>
